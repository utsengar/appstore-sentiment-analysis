...
class Splitter(object):
    ...
    def split(self, text):
        ...
        tokenized_sentences = [self.nltk_tokenizer.tokenize(
...
class POSTagger(object):
    ...
    def pos_tag(self, sentences):
        ...
        # adapt format
        pos = [[(word, word, [postag]) for (
            word, postag) in sentence] for sentence in pos]
        return pos
...
class DictionaryTagger(object):
    ...
    def tag_sentence(self, sentence, tag_with_lemmas=False):
        ...
        while (i < N):
            ...
            tagged = False
            while (j > i):
                expression_form = ' '.join([word[
                                           0] for word in sentence[i:j]]).lower()
                expression_lemma = ' '.join([word[
                                            1] for word in sentence[i:j]]).lower()
                if tag_with_lemmas:
...
if __name__ == "__main__":
    #f = codecs.open("../RedLaser_reviews_March5_2013", "r", "utf-8")
    #text = f.read()
